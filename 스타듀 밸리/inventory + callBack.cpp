...
itemType::Enum inventory::getItemType(string itemName)
{
	if (itemName == "수액" || itemName == "민들레" || itemName == "사람" || itemName == "멜론" || itemName == "사탕 수수" ||
		itemName == "양파" || itemName == "당근"|| itemName=="멜론" || itemName == "grass")
	{
		return itemType::FOOD;
	}
	else if ( itemName == "_stone" || itemName == "석탄" )
	{
	...
	else if (itemName == "물뿌리개" || itemName == "도끼" || itemName == "player" )
	{
		return itemType::TOOL;
	}
	else if (itemName == "상자" ||itemName == "울타리")
	{
		return itemType::SETTING;
	}
	else if (itemName == "당근씨앗")
	{
